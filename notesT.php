      ...
      <div style="text-align: center; margin-top: 150px;">
        <form method="POST" name="FileUpload" enctype="multipart/form-data">
          ...
          <div class="custom-file" style="width: 450px;">
            <input type="file" class="custom-file-input" id="NotesID" name="Notes" multiple>
            <label class="custom-file-label" for="NotesID" style="overflow: hidden;">Choose File</label>
          </div>
          <br>
