...
{ 
  $name=$_FILES['Tutorials']['name'];
  $name123=$_FILES['Tutorials']['tmp_name'];
  //echo $name123;
  $filesize= $_FILES['Tutorials']['size'];
  $EverthingOk=0;
  ...
  if($EverthingOk==0)
  {
    $Query="INSERT INTO Tutorials (FileName) VALUES('$name')";
      ...
      <div style="text-align: center; margin-top: 150px;">
        <form method="POST" name="FileUpload" enctype="multipart/form-data">
          ...
          <div class="custom-file" style="width: 450px;">
            <input type="file" class="custom-file-input" id="TutorialsID" name="Tutorials" multiple>
            <label class="custom-file-label" for="TutorialsID" style="overflow: hidden;">Choose File</label>
          </div>
          <br>
